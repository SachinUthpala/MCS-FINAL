            ...
            <div class="col-12"> <!-- changed from col-xl-8 col-lg-6 to col-12 -->
                <div class="billing_details">
                    <div class="billing_title">
                        ...
                        <h2>Add Product Navigation</h2>
                    </div>
                    <form class="billing_details_form w-100"> <!-- added w-100 just in case -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="billing_input_box">
                                    <input type="text" name="MainNav" placeholder="Main Navigation Name" required>
                                </div>
                            </div>
                        </div>

                         <div class="main-menu-two__btn-box">
                        <button class="thm-btn" style="border: none !important;">Add Sub Navigations</button>
                     </div>
...
<div class="text-end mt-2">
                            ...
                            <div class="col-12">
                                <div class="billing_details_form-btns">
                                    <div class="billing_details_form-btn-1">
                                        <button type="submit" class="thm-btn">Add Navigation<span class="icon-right-arrow"></span></button>
                                    </div>
    ...
    <!-- page functions -->
     <script src="./Functions/AddNavigation.js"></script>
