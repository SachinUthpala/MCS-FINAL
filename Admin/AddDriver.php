                ...
                <div class="billing_details">
                    ...
                    <form class="billing_details_form w-100" id="myForm"> <!-- added w-100 just in case -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="billing_input_box">
                                    <input type="text" name="discription" placeholder="Driver Discription" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="billing_details_form-btns">
                                    <div class="billing_details_form-btn-1">
                                        <button type="submit" class="thm-btn">Add Driver<span class="icon-right-arrow"></span></button>
                                    </div>
                                    <div class="billing_details_form-btn-2">
                                        <button type="submit" class="thm-btn">Reset<span class="icon-right-arrow"></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div style="margin-top:10px; display:none;" id="progressWrapper">
    <div style="width:100%; background:#e0e0e0; border-radius:4px;">
        <div id="progressBar"
             style="width:0%; height:10px; background:#28a745; border-radius:4px;"></div>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fileInput.addEventListener('change', function () {
        if (this.files.length > 0) {
            fileNameText.innerText = 'Selected file: ' + this.files[0].name;
        } else {
