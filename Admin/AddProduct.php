...
$mainSql = "SELECT * FROM main_navigation";
$mainSmtp = $pdo->prepare($mainSql);
$mainSmtp->execute();
...
<body class="custom-cursor">
        ...
        <div class="billing_input_box">
            <div class="select-box">
                <select class="wide" name="mainNav" id="mainNav">
                    <option data-display="Select Main Category">Select Main Category</option>

                    <?php while ($row = $mainSmtp->fetch(PDO::FETCH_ASSOC)) { ?>
                        <option value="<?php echo $row['nav_code']; ?>"><?php echo $row['nav_name']; ?></option>
                    <?php } ?>
                              ...
                              <div class="row" id="subNavRow" style="display:none;">
                                    <div class="col-xl-12">
                                        <div class="billing_input_box">
                                            <div class="select-box">
                                                <select class="wide" name="subNav" id="subNav">
                                                    <option data-display="Select Sub Category">Select Sub Category</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="billing_input_box">
                                            <textarea placeholder="Product Discription" name="ProductDiscription" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="billing_input_box" style="display: flex; align-items: center;">
                                            <label class="custom-file">
                                                <input type="file" id="fileInput" name="ProductImage" required>
                                ...
                                <hr>
                                <h4>Prduct Specifications</h4>
                                <br>

                                <div class="main-menu-two__btn-box">
                                    <button class="thm-btn" style="border: none !important;">Add Product Specs</button>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="billing_details_form-btns">
                                            <div class="billing_details_form-btn-1">
                                                <button type="submit" class="thm-btn">Add Product<span class="icon-right-arrow"></span></button>
                                            </div>
    ...
    <!-- page functions -->
     ...
     <script src="./Functions/AddProductNav.js"></script>
