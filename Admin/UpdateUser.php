    ...
    <!-- header start -->
     ...
     <!--Start Cart Page-->
        <section class="wishlist-page" >
            <h3 class="text-center">All Our System Users</h3>
                ...
                <div class="table-responsive">
                    <table class="table wishlist-table" id="myTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($row['AdminType'] == 1){ ?>
                                    <span style="background: #ff0666ff; padding: 10px; border-radius: 5px;">Admin User</span>
                                    <?php } else { ?>
                                        <span style="background: #ca6200ff; padding: 10px; border-radius: 5px;" > Normal User</span>
                                        <?php } ?>
                            </td>
                            ...
                            <td>
                                    <button 
                                        ...
                                        onclick="location.href='./UpdateUserSec.php?userID=<?php echo urlencode($row['userId']); ?>'"
