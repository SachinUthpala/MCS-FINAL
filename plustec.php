                    ...
                    <div class="thm-breadcrumb__box">
                        <ul class="thm-breadcrumb list-unstyled">
                            ...
                            <li>Document Scanners</li>
                             <li><span class="icon-right-arrow-1"></span></li>
                            <li>The Plustek Smart Office PS3140U</li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="swiper-wrapper ">
                                            <div class="swiper-slide d-flex justify-content-center p-2" >
                                                <div class="product-details__img" >
                                                    <img src="assets/images/prroducts/Plustek-removebg-preview.png" alt="" style="height: 400px !important; width: auto !important;">
                                                </div>
                                            </div>
                        ...
                        <div class="product-details__right">
                            <div class="product-details__top">
                                <h3 class="product-details__title">
                                   The Plustek Smart Office PS3140U
                                </h3>
                            </div>
                            ...
                            <div class="product-details__content">
                                ...
                                The Plustek Smart Office PS3140U is a high-speed duplex document scanner designed for office environments. 1 It features a 100-sheet automatic document feeder (ADF) and can scan up to 40 pages per minute in color or black and white. 2 The scanner boasts a 600 dpi optical resolution and can scan documents in various formats, including A4, Letter, and Business Cards. 2 Additional features include automatic image optimization, multi-feed detection, and compatibility with Windows and Mac operating systems. 

                                </p>
                                <p class="product-details__content-text2">REF. Document Scanners<br>
                                    The Plustek Smart Office PS3140U</p>
                            </div>
                            ...
                            <div class="product-details__inner">
                                ...
                                <div class="product-details__buttons-boxes">
                                    ...
                                    <div class="product-details__buttons-1">
                                        <a href="https://plustek.com/eu/products/workgroup-scanners/smartoffice-ps3140u/spec.php" target=" " class="thm-btn">Spec Link<span class="icon-right-arrow"></span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-details__additional-information-content">
                                        <div class="product-description__list">
                                            <ul class="list-unstyled">
                                                <li>
                                                    <p><span class="icon-right-arrow"></span>High-Speed Duplex Scanning: Scan up to 40 pages per minute in color or black and white, doubling your productivity with duplex scanning.</p>
                                                   
                                                </li>

                                                <li>
                                                    <p><span class="icon-right-arrow"></span>Large Capacity ADF: The 100-sheet automatic document feeder allows for uninterrupted scanning of multiple documents.</p>
                                                   
                                                </li>

                                                <li>
                                                    <p><span class="icon-right-arrow"></span>Versatile Scanning: Handle various document formats, including A4, Letter, and Business Cards.</p>
                                                   
                                                </li>

                                                <li>
                                                    <p><span class="icon-right-arrow"></span> Superior Image Quality: Enjoy 600 dpi optical resolution for crisp and clear scans.</p>
                                                   
                                                </li>

                                                <li>
                                                    <p><span class="icon-right-arrow"></span> Automatic Image Optimization: Enhance scanned images with features like automatic color adjustment and noise reduction.</p>
                                                   
                                                </li>

                                                <li>
                                                    <p><span class="icon-right-arrow"></span>Reliable Paper Feeding: The optimized friction roller system minimizes paper jams and ensures smooth feeding.</p>
